...
export const AuthUserCard = ({ currentUser, updateAuthUser }) => {
    return (
        <div className='grid grid-auth-user-card'>
            ...
            <div className='is-flex is-justify-content-flex-end is-align-items-center'>
                <button className='button mr-1 is-link is-size-7' onClick={signOutPlayer(updateAuthUser, currentUser.uid)}>Sign Out</button>
            </div>
        </div>
    )
}
